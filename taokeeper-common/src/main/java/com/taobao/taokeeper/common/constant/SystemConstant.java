...
public class SystemConstant {
	...
	public static String userNameOfSSH = "";
	public static String passwordOfSSH = "";
	
	public static int portOfSSH     = 22;

	/** ZooKeeper监控信息存储设置客户端统计信息文件存放目录 */
	public static String dataStoreBasePath = "/opt/taokeeper-monitor/datastore/";
	
	public static String dataStoreCategoryPath_clientStat = File.separator+"ZooKeeperClientThroughputStat"+File.separator;
