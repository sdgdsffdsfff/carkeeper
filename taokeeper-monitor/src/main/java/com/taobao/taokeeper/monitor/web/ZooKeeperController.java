    ...
    public String registerZooKeeperHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (0 < clusterId) {
                ...
                alarmSettingsDAO.addAlarmSettings(new AlarmSettings(clusterId, "5", "60", "70", "2", "hot66hot@126.com", "13502171129", "yijunzhang@sohu-inc.com", "200", "1000", dataPath, dataPath, "70", ""));
