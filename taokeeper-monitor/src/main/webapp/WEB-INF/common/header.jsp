...
<div id="navcolumn" style="height: 500px;">
	<ul>
		...
		<li>Admin
			<ul>
                <li><a	href="<c:url value="manager.do?method=zooKeeperConfigPAGE" />">集群操作</a></li>
				<li><a href="<c:url value="admin.do?method=switchOfNeedAlarmPAGE" />">报警开关</a></li>
				<li><a href="<c:url value="admin.do?method=setSystemConfigPAGE" />">系统设置</a></li>
			</ul>
		</li>
